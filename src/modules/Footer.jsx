      ...
      <div className={style.about_div}>
        ...
        <div className={style.info}>
          <ul>
            ...
            <li><a href="#">Аренда тепловозов</a></li>
        ...
        <div className={style.contacts}>
          <ul>
            <li>
              ...
              <a href="tel:+7 (xxx) xxx-xx-xx"><b>+7 (916) 332-86-08</b></a>
            </li>
            <li>
              <img src="/imgs/location.svg" alt="loacation" />
              <span>141303, Московская Область, г.о. Сергиево-Посадский, г. Сергиев Посад, ул. Пограничная, д. 5, помещ. 10</span>
            </li>
            <li>
